...
--
-- Host: 127.0.0.1
-- Generation Time: 07 مايو 2026 الساعة 00:05
...
(6, 'رجال ألمع', ' الجنوبية', 'من أبرز الوجهات التراثية والسياحية، وهي محافظة تقع في منطقة عسير.', '', 'Rijal_Almaa.jpg', 'قرية رجال ألمع التراثية، متحف ألمع للتراث، حصن آل علوان التاريخي', 'جولات ثقافية وتاريخية، التصوير الفوتوغرافي للمباني الحجرية، تجربة المأكولات الشعبية، المشي الجبلي، حضور مهرجانات العسل والزهور.', 'honey.jpg', '', '', 'حائزة على لقب أفضل القرى السياحية عالمياً، تشتهر بفن \"القط العسيري\" المسجل لدى اليونسكو');
